...
/**
 * Basicreports command
 *
 * @author Tobias Kahse <tobias.kahse@outlook.com>
 * @version 0.1
 */
public class Basicreports extends Command {

    /**
     * Constructs a Basicreports command using a request and a response object.
     *
     * @param request The request object of the request.
     * @param response The response object of the request.
     */
    public Basicreports(HttpServletRequest request, HttpServletResponse response) {
        super(request, response);
        this.requiredUserType = UserType.STANDARD_USER;
        this.viewFile = "/basicreports.jsp";
    }
