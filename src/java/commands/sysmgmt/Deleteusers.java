 ...
 */
public class Deleteusers extends Command {

    /**
     * Constructs a Deleteusers command using a request and a response object.
     *
     * @param request The request object of the request.
     * @param response The response object of the request.
     */
    public Deleteusers(HttpServletRequest request, HttpServletResponse response) {
        super(request, response);
        this.viewFile = "/deleteusers.jsp";
