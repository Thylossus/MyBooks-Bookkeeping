 ...
 */
public class GenerateSystemStatistics extends ModelComponent{

    /**
     * Construct a GenerteSystemStatistics object
     * @param request The request's request object
     * @param response The request's response object
     */
    public GenerateSystemStatistics(HttpServletRequest request, HttpServletResponse response) {
        super(request, response);
    }

    /**
     * Process the action for GenerateSystemStatistics
     */
    @Override
    public void process() {
