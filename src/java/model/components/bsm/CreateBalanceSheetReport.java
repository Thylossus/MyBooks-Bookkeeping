 ...
 */
public class CreateBalanceSheetReport extends ModelComponent{

    /**
     * Construct a CreateBalanceSheetReport object
     * @param request The request's request object
     * @param response The request's response object
     */
    public CreateBalanceSheetReport(HttpServletRequest request, HttpServletResponse response) {
        super(request, response);
    }

    /**
     * Process the action for CreateBalanceSheetReport
     */
    @Override
    public void process() {
