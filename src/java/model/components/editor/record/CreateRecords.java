 ...
 */
public class CreateRecords extends ModelComponent{

    /**
     * Construct a CreateRecords object
     * @param request The request's request object
     * @param response The request's response object
     */
    public CreateRecords(HttpServletRequest request, HttpServletResponse response) {
        super(request, response);
    }

    /**
     * Process the action for CreateRecords
     */
    @Override
    public void process() {
