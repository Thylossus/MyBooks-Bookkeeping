 ...
 */
public class DeleteCategory extends ModelComponent{

    /**
     * Construct a DeleteCategory object
     * @param request The request's request object
     * @param response The request's response object
     */
    public DeleteCategory(HttpServletRequest request, HttpServletResponse response) {
        super(request, response);
    }

    /**
     * Process the action for DeleteCategory
     */
    @Override
    public void process() {
