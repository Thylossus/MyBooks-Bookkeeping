 ...
 */
public class CreateCategory extends ModelComponent{

    /**
     * Construct a CreateCategory object
     * @param request The request's request object
     * @param response The request's response object
     */
    public CreateCategory(HttpServletRequest request, HttpServletResponse response) {
        super(request, response);
    }

    /**
     * Process the action for CreateCategory
     */
    @Override
    public void process() {
